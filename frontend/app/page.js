...
export default function LandingPage() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: S.bg, fontFamily: 'var(--font-family)', color: S.textPrimary, overflowX: 'hidden' }}>
      ...
      <div style={{ position: 'fixed', top: '-200px', left: '-200px', width: '600px', height: '600px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(79,140,255,0.07) 0%, transparent 65%)', pointerEvents: 'none', zIndex: 0 }} />
      <div style={{ position: 'fixed', bottom: '-200px', right: '-100px', width: '500px', height: '500px', borderRadius: '50%', background: 'radial-gradient(circle, rgba(129,140,248,0.06) 0%, transparent 65%)', pointerEvents: 'none', zIndex: 0 }} />

      <div style={{ position: 'relative', zIndex: 1 }}>

        {/* NAVBAR */}
        <nav style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 48px', height: '64px', background: 'rgba(22,26,34,0.8)', borderBottom: `1px solid ${S.border}`, backdropFilter: 'blur(12px)', position: 'sticky', top: 0, zIndex: 100 }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
            <Link href="/help" style={{ padding: '7px 18px', background: 'transparent', border: 'none', color: S.textSecondary, fontSize: '13px', fontWeight: 500, textDecoration: 'none', transition: 'color 180ms ease' }}
              onMouseEnter={e => e.currentTarget.style.color = S.textPrimary}
              onMouseLeave={e => e.currentTarget.style.color = S.textSecondary}>
              Help
            </Link>
            <Link href="/login" style={{ padding: '7px 18px', background: 'transparent', border: `1px solid ${S.border}`, borderRadius: '8px', color: S.textSecondary, fontSize: '13px', fontWeight: 500, textDecoration: 'none', transition: 'all 180ms ease' }}
            ...
            <Link href="/register" style={{ padding: '7px 18px', background: `linear-gradient(135deg, ${S.accent}, #6366f1)`, border: 'none', borderRadius: '8px', color: 'white', fontSize: '13px', fontWeight: 600, textDecoration: 'none', boxShadow: `0 4px 14px rgba(79,140,255,0.3)`, transition: 'all 180ms ease' }}
        ...
        {/* HERO */}
        <section style={{ padding: '110px 48px 90px', textAlign: 'center', maxWidth: '820px', margin: '0 auto', animation: 'fadeUp 0.5s ease forwards' }}>
          <h1 style={{ fontSize: '56px', fontWeight: 800, color: S.textPrimary, lineHeight: 1.12, letterSpacing: '-0.02em', marginBottom: '24px', fontFamily: 'var(--font-serif)' }}>
            Your AI sales assistant<br />
            <span style={{ background: `linear-gradient(135deg, ${S.accent}, #818cf8)`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              that never sleeps.
            </span>
          </h1>
          <p style={{ fontSize: '18px', color: S.textSecondary, lineHeight: 1.75, marginBottom: '44px', maxWidth: '580px', margin: '0 auto 44px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Link href="/register" style={{ padding: '15px 36px', background: `linear-gradient(135deg, ${S.accent}, #6366f1)`, borderRadius: '12px', color: 'white', fontSize: '15px', fontWeight: 700, textDecoration: 'none', boxShadow: `0 4px 24px rgba(79,140,255,0.35)`, transition: 'all 180ms ease', display: 'inline-block', letterSpacing: '0.01em' }}
            ...
            <Link href="/login" style={{ padding: '15px 36px', background: 'transparent', border: `1px solid ${S.border}`, borderRadius: '12px', color: S.textSecondary, fontSize: '15px', fontWeight: 500, textDecoration: 'none', transition: 'all 180ms ease', display: 'inline-block' }}
              onMouseEnter={e => { e.currentTarget.style.borderColor = S.accent; e.currentTarget.style.color = S.accent; }}
              onMouseLeave={e => { e.currentTarget.style.borderColor = S.border; e.currentTarget.style.color = S.textSecondary; }}>
              Sign in →
            </Link>
        ...
        <section style={{ padding: '0 48px 80px', maxWidth: '900px', margin: '0 auto' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
            {[
              ...
              <div key={i} style={{ padding: '28px 24px', background: S.surface, border: `1px solid ${S.border}`, borderRadius: '16px', textAlign: 'center', transition: 'all 200ms ease' }}
                ...
                <div style={{ fontSize: '38px', fontWeight: 800, color: S.accent, letterSpacing: '-0.02em', marginBottom: '6px' }}>{stat.value}</div>
        ...
        {/* FEATURES */}
        <section id="features" style={{ padding: '80px 48px', background: S.surface, borderTop: `1px solid ${S.border}`, borderBottom: `1px solid ${S.border}` }}>
          <div style={{ maxWidth: '960px', margin: '0 auto' }}>
            <div style={{ textAlign: 'center', marginBottom: '56px' }}>
              ...
              <p style={{ fontSize: '15px', color: S.textSecondary, maxWidth: '500px', margin: '0 auto' }}>
                One platform that handles your entire lead pipeline — from first message to closed deal.
              </p>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '20px' }}>
              {[
                { icon: '🤖', title: 'AI Chatbot', desc: 'Automatically replies to every inquiry. Asks the right questions and qualifies leads before you even wake up.', color: '#4F8CFF' },
                { icon: '🔥', title: 'Lead Scoring', desc: 'Every lead is scored Hot, Warm, or Cold automatically. Focus your energy on leads most likely to convert.', color: '#f97316' },
                { icon: '🔄', title: 'Follow-up Automation', desc: 'Leads that go silent get automatic follow-ups at Day 1, Day 3, and Day 7. Customizable messages.', color: '#a78bfa' },
                { icon: '📊', title: 'Lead Dashboard', desc: 'Every lead in one place. See who inquired, what they need, when they messaged. Update status in one click.', color: '#34d399' },
                { icon: '⚡', title: 'Instant Notifications', desc: 'Get notified the moment a new lead arrives — with their name, requirements, and contact details.', color: '#f59e0b' },
                { icon: '💬', title: 'Conversation History', desc: 'Every message between your chatbot and the lead is saved. See exactly what was said and what they need.', color: '#818cf8' },
              ].map((feature, i) => (
                <div key={i} style={{ padding: '28px', background: S.surface2, border: `1px solid ${S.border}`, borderRadius: '16px', transition: 'all 200ms ease' }}
          ...
          <div style={{ maxWidth: '700px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              {[
                ...
                { step: '03', title: 'Share your number', desc: 'Give leads your number. Every message is captured, qualified, and shown in your dashboard automatically.' },
              ].map((item, i) => (
                <div key={i} style={{ display: 'flex', alignItems: 'flex-start', gap: '20px', padding: '24px', background: S.surface, border: `1px solid ${S.border}`, borderRadius: '16px', textAlign: 'left', transition: 'all 200ms ease' }}
        ...
        <section id="pricing" style={{ padding: '80px 48px' }}>
          <div style={{ maxWidth: '480px', margin: '0 auto', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '15px', color: S.textSecondary, marginBottom: '40px' }}>One plan. Everything included. No surprises.</p>
            <div style={{ padding: '40px', background: S.surface, border: `1px solid rgba(79,140,255,0.25)`, borderRadius: '24px', boxShadow: '0 0 60px rgba(79,140,255,0.06)' }}>
              ...
              <Link href="/register" style={{ display: 'block', padding: '14px', background: `linear-gradient(135deg, ${S.accent}, #6366f1)`, borderRadius: '12px', color: 'white', fontSize: '15px', fontWeight: 700, textDecoration: 'none', textAlign: 'center', boxShadow: `0 4px 20px rgba(79,140,255,0.3)`, transition: 'all 180ms ease' }}
        ...
        {/* FOOTER */}
        <footer style={{ borderTop: `1px solid ${S.border}`, padding: '48px', background: S.surface }}>
          <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '48px', flexWrap: 'wrap', gap: '32px' }}>
              <div style={{ maxWidth: '260px' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                  ...
                  <span style={{ fontWeight: 800, fontSize: '18px', fontFamily: 'Georgia, serif' }}>
                    <span style={{ color: S.textPrimary }}>Our</span><span style={{ color: S.accent }}>ivo</span>
                  </span>
                </div>
                <p style={{ fontSize: '13px', color: S.textMuted, lineHeight: 1.8 }}>
                  AI-powered tools to capture, qualify, and follow up with every customer automatically.
                </p>
              </div>
              <div style={{ display: 'flex', gap: '64px', flexWrap: 'wrap' }}>
                <div>
                  <div style={{ fontSize: '11px', fontWeight: 700, color: S.textMuted, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '16px' }}>Product</div>
                  {[['Features', '#features'], ['Pricing', '#pricing'], ['Help', '/help'], ['Feedback', '/feedback']].map(([label, href]) => (
                    <div key={href} style={{ marginBottom: '10px' }}>
                      <Link href={href} style={{ fontSize: '13px', color: S.textSecondary, textDecoration: 'none' }}
                        onMouseEnter={e => e.currentTarget.style.color = S.textPrimary}
                        onMouseLeave={e => e.currentTarget.style.color = S.textSecondary}>
                        {label}
                      </Link>
                ...
                <div>
                  <div style={{ fontSize: '11px', fontWeight: 700, color: S.textMuted, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '16px' }}>Company</div>
                  {[['About Us', '/about'], ['Contact', '/contact'], ['Privacy Policy', '/privacy'], ['Terms & Conditions', '/terms']].map(([label, href]) => (
                    <div key={href} style={{ marginBottom: '10px' }}>
                      <Link href={href} style={{ fontSize: '13px', color: S.textSecondary, textDecoration: 'none' }}
                        onMouseEnter={e => e.currentTarget.style.color = S.textPrimary}
                        onMouseLeave={e => e.currentTarget.style.color = S.textSecondary}>
                ...
                <div>
                  <div style={{ fontSize: '11px', fontWeight: 700, color: S.textMuted, letterSpacing: '0.1em', textTransform: 'uppercase', marginBottom: '16px' }}>Contact</div>
                  <div style={{ marginBottom: '10px' }}>
                    <a href="mailto:support@ourivo.com" style={{ fontSize: '13px', color: S.textSecondary, textDecoration: 'none' }}>support@ourivo.com</a>
                  </div>
                  <div>
                    <a href="https://wa.me/917294034023" target="_blank" rel="noopener noreferrer" style={{ fontSize: '13px', color: S.textSecondary, textDecoration: 'none' }}>WhatsApp Us</a>
                  </div>
                </div>
              </div>
            </div>
            <div style={{ borderTop: `1px solid ${S.border}`, paddingTop: '24px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
              ...
              <span style={{ fontSize: '13px', color: S.textMuted }}>Made with ❤️ in India</span>
            </div>
          </div>
        </footer>
