        ...
        <div style={{
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{
                            ...
                            marginBottom: '32px', maxWidth: '260px'
                        }}>
                        ...
                        <div style={{ display: 'flex', gap: '8px' }}>
                            {[
                                ...
                                >
                                    <div style={{ color: S.accent, fontSize: '18px', fontWeight: 700, marginBottom: '2px' }}>
                                        {s.value}
                                    </div>
                                    <div style={{ color: S.textMuted, fontSize: '10px', fontWeight: 500 }}>
                                        {s.label}
                                    </div>
                                </div>
                            ))}
                    ...
                    <div style={{
                        ...
                        <p style={{
                            color: S.textSecondary,
                            fontSize: '12px', lineHeight: 1.75, marginBottom: '12px'
                        }}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                            ...
                            <div>
                                <div style={{ color: S.textPrimary, fontSize: '12px', fontWeight: 600 }}>
                                    Rahul Sharma
                                </div>
                                <div style={{ color: S.textMuted, fontSize: '11px' }}>
                ...
                <div style={{
                    ...
                    <p style={{
                        textAlign: 'center', fontSize: '13px', color: S.textSecondary
                    }}>
                        New to WhatsApp CRM?{' '}
                    ...
                    <div style={{
                        ...
                        {[
                            ...
                            <span key={i} style={{
                                ...
                                fontSize: '11px', color: S.textMuted, fontWeight: 500
                            }}>
                                {t.icon} {t.text}
                            </span>
                        ))}
